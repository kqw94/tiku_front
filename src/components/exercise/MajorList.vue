<template>
  <div>
    <el-button type="primary" @click="$emit('show-add-dialog', 'major')">添加科目</el-button>
    <el-table :data="majors" style="width: 100%; margin-top: 20px;" border>
      ...
      <el-table-column label="操作" width="300">
        <template #default="scope">
          ...
          <el-button type="text" @click="$emit('edit-item', scope.row, 'major')">编辑</el-button>
          <el-button type="text" @click="$emit('delete-item', scope.row, 'major')">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
