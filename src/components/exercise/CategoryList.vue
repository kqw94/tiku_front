<template>
  <div>
    <el-button type="primary" @click="$emit('show-add-dialog', 'category')">添加专业</el-button>
    <el-table :data="categories" style="width: 100%; margin-top: 20px;" border>
      ...
      <el-table-column label="操作" width="300">
        <template #default="scope">
          ...
          <el-button type="text" @click="$emit('edit-item', scope.row, 'category')">编辑</el-button>
          <el-button type="text" @click="$emit('delete-item', scope.row, 'category')">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
